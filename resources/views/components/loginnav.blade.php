        ...
        <div class="col-12">
            ...
            <nav
                ...
                <div class="container-fluid ps-2 pe-0">
                    ...
                    <button class="navbar-toggler shadow-none shadow-lg-lg ms-2" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0" id="navigation">
                        <ul class="navbar-nav navbar-nav-hover mx-auto">
                            <li class="nav-item dropdown dropdown-hover mx-2">
                                ...
                                <div class="dropdown-menu dropdown-menu-animation dropdown-xl p-3 border-radius-xl mt-0 mt-lg-3 shadow-none shadow-lg-lg"
                                        ...
                                        <div class="col-12 px-4 py-2">
                                            <div class="row">
                                                <div class="col-4 position-relative">
                                                    ...
                                                    <a href="../../../pages/dashboards/landing.html"
                            ...
                            <li class="nav-item dropdown dropdown-hover mx-2">
                                ...
                                <div class="dropdown-menu dropdown-menu-animation dropdown-lg border-radius-xl p-3 mt-0 mt-lg-3 shadow-none shadow-lg-lg"
                            ...
                            <li class="nav-item dropdown dropdown-hover mx-2">
                                ...
                                <div class="dropdown-menu dropdown-menu-animation dropdown-md dropdown-md-responsive p-3 border-radius-lg mt-0 mt-lg-3 shadow-none shadow-lg-lg"
                            ...
                            <li class="nav-item dropdown dropdown-hover mx-2">
                                ...
                                <div class="dropdown-menu dropdown-menu-animation dropdown-lg p-3 border-radius-xl mt-0 mt-lg-3 shadow-none shadow-lg-lg"
                            ...
                            <li class="nav-item dropdown dropdown-hover mx-2">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animation dropdown-lg mt-0 mt-lg-3 p-3 border-radius-lg shadow-none shadow-lg-lg"
